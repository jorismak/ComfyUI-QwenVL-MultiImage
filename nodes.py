...
def load_model(model_name: str, quantization: str, device: str = "auto"):
    ...
    if is_fp8_model:
        ...
        load_kwargs["torch_dtype"] = torch.float8_e4m3fn if hasattr(torch, 'float8_e4m3fn') else torch.float16
...
class QwenVL_MultiImage:
    ...
    def generate(self, images, model_name, system_prompt, user_prompt, 
                 quantization, max_tokens, keep_model_loaded, seed,
                 images_batch_2=None, images_batch_3=None):
        """
...
class QwenVL_MultiImage_Advanced:
    ...
    def generate(self, images, model_name, system_prompt, user_prompt,
                 quantization, max_tokens, temperature, top_p, top_k,
                 repetition_penalty, num_beams, keep_model_loaded, seed, device,
                 images_batch_2=None, images_batch_3=None):
        """
